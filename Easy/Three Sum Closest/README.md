<h2><a href="https://practice.geeksforgeeks.org/problems/three-sum-closest/1?page=3&status[]=unsolved&company[]=Google&sortBy=submissions">Three Sum Closest</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array,&nbsp;<strong>Arr</strong>&nbsp;of <strong>N</strong> numbers, and another number <strong>target</strong>,&nbsp;find three integers in the array&nbsp;such that the sum is closest to the target. Return the sum of the three integers.</span></p>
