<h2><a href="https://practice.geeksforgeeks.org/problems/remainder-of-array-multiplication0140/1?page=1&category[]=modular%20arithmetic&sortBy=submissions">Remainder of array multiplication</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given an array <strong>arr[]</strong> of numbers of size <strong>N</strong>. You need to multiply these numbers and find the remainder when the product of these numbers is divided by a number <strong>K</strong>.</span></p>
...
</div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>number-theory</code>&nbsp;<code>modular arithmetic</code>&nbsp;