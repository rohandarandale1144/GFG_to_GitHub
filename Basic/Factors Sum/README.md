<h2><a href="https://practice.geeksforgeeks.org/problems/factors-sum2016/1?page=1&category[]=Factorization&sortBy=submissions">Factors Sum</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>,&nbsp;find the sum of all its&nbsp;factors.</span></p>
