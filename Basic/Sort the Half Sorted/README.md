<h2><a href="https://practice.geeksforgeeks.org/problems/sort-the-half-sorted2157/1?page=1&difficulty[]=-1&status[]=unsolved&category[]=two-pointer-algorithm&sortBy=submissions">Sort the Half Sorted</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer array of which both first half and second half are sorted. The task is to merge two sorted halves of the&nbsp;array into a&nbsp;single sorted array.<br>
