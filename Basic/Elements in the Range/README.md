<h2><a href="https://practice.geeksforgeeks.org/problems/elements-in-the-range2834/1?page=2&difficulty[]=-1&status[]=unsolved&sortBy=submissions">Elements in the Range</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr[]</strong> containing positive elements. A and B are two numbers defining a range. The task is to check if the array contains all elements in the given range.</span></p>
