<h2><a href="https://practice.geeksforgeeks.org/problems/krishnamurthy-number1323/1?page=1&category[]=factorial&sortBy=submissions">Krishnamurthy number</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A Krishnamurthy number is a number whose sum of the factorial of digits is equal to the number itself. Given a number <strong>N</strong> as input. Print "YES" if it's a Krishnamurthy Number, else Print "NO".</span></p>
