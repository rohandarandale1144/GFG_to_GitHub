<h2><a href="https://practice.geeksforgeeks.org/problems/c-pointers-set-1introduction/1?page=1&category[]=Pointers&sortBy=submissions">C++ Pointers ( Incrementing a variable) | Set 1</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a pointer to a variable <strong>a</strong>, the task is to complete the function <strong>updateVar() </strong>which will increment the value of the variable by <strong>10</strong>. The function does not returns anything.</span></p>
